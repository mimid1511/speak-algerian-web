...
const Hero = () => {
    ...
    return (
        <div className="relative w-full h-64 bg-gray-900 shadow-sm">
            <div
            ...
            <div className="relative z-10 flex flex-col items-center justify-center h-full space-y-4 bg-black bg-opacity-50 px-4">
                <h1 className="text-2xl font-bold text-white md:text-4xl">Bienvenue - Maraḥba - مرحبا</h1>
                    ...
                    <form className="w-full max-w-md">
                        <div className="flex items-center py-2">
                            <div className="form-append">
                                ...
                                <button className="btn btn-primary bg-primary-light rounded-none"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 16 16"><path fill="currentColor" fillRule="evenodd" d="M11.5 7a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0m-.82 4.74a6 6 0 1 1 1.06-1.06l2.79 2.79a.75.75 0 1 1-1.06 1.06z" clipRule="evenodd"></path></svg></button>
                            </div>
                        </div>
                    </form>
