...
const Blog = () => {
    return (
        ...
        <section className="px-4 py-20 mx-auto max-w-7xl bg-white">
            ...
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                <div>
                    <a href="#">
                        <img src="https://news.radioalgerie.dz/sites/default/data/2024-03/algerie.jpg" className="object-cover w-full h-56 mb-5 bg-center " alt="Kutty" loading="lazy" />
                    </a>
            ...
            <div className="flex flex-col items-center justify-center mt-20 space-x-0 space-y-2 md:space-x-2 md:space-y-0 md:flex-row">
                <a href="#" className="w-full rounded-none btn btn-primary btn-xl md:w-auto">Previous Page</a>
                <a href="#" className="w-full rounded-none btn btn-primary btn-xl md:w-auto">Next Page</a>
            </div>
        </section>
