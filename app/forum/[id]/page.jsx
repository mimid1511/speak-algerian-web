...
const TopicPage = ({ params }) => {
        ...
        <div className="card rounded-none animate-pulse">
            <div className="grid grid-cols-[auto,1fr]">
                <div className="flex flex-col items-center p-4 bg-slate-100">
                    <div className="avatar bg-font border w-12 h-12 mb-1 rounded-full"></div>
                    <div className="h-3 bg-font rounded w-3/4"></div>
                </div>
                <div>
                    <div className="card-header rounded-none flex justify-between">
                        <div className="h-4 bg-font rounded w-1/4"></div>
                        <div className="h-4 bg-font rounded w-6"></div>
                    </div>
                    <div className="card-body rounded-none p-4">
                        <div className="h-3 bg-font rounded w-full mb-2"></div>
                        <div className="h-3 bg-font rounded w-3/4"></div>
                    </div>
                    <div className="justify-end card-footer rounded-none">
                        <div className="h-7 bg-font rounded w-1/4"></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    return (
        <Layout type={"root"}>
            <Title breadCrumb={[{ link: "/forum", name: "Forum" }]} title={!loadingTopics ? topic?.title : <div className="w-full h-8 bg-font animate-pulse"></div>} />
            <div className="mx-auto p-4 md:p-4 bg-font">
                                        ...
                                        <div>
                                            <div className="card-header rounded-none flex justify-between">
                                                ...
                                                {/* <div className="relative inline-block text-left">
                                                    ...
                                                    <div className="dropdown-content hidden absolute right-0 mt-2 w-48 bg-white border border-gray-200 shadow-lg z-10">
                                                        <ul className="py-1">
                                                            <li>
