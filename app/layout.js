    ...
    <html lang="fr">
      <body className={inter.className}>
        <div className="h-screen w-full bg-white relative flex overflow-hidden">
          {/* Sidebar */}
          <aside className="h-full w-16 flex flex-col space-y-8 items-center justify-center bg-primary text-white">
