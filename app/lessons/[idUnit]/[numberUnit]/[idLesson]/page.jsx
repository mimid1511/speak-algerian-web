                ...
                <div className="bg-white md:p-5">
                    ...
                    <div className="flex flex-wrap justify-center mt-4">
                        {loading
                            ? Array.from({ length: 4 }).map((_, index) => (
                                <div key={index} className="m-4 md:w-1/2 h-auto">
                                    <div className="skeleton bg-font animate-pulse h-96 mb-10 w-full"></div>
                                </div>
                            ))
                        ...
                        <div className="md:btn-group mb-4" role="group" aria-label="Align Text">
                            ...
                            {isUserLoggedIn ?
                                <button onClick={() => router.push(`/assessments/${unitId}/${lessonId}`)} type="button" className="btn btn-primary rounded-none">
